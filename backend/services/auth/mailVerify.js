module.exports = class {
    ...
    sendVerificationMail(email, key) {
        const mailOptions = {
            ...
            `<a href="https://${process.env.HOST}:${process.env.PORT}/verifyEmail/${key}">Click Me to Verify</a>` +
    ...
    sendPasswordResetMail(email, key) {
        const mailOptions = {
            ...
            `<a href="https://${process.env.HOST}:${process.env.PORT}/resetPassword/${key}">Click Me to Reset</a>` + 
            `<p>This is an automatic message sent by system, please do not reply to this message</p>`// html body
        };
        this.transporter.sendMail(mailOptions)
    }
